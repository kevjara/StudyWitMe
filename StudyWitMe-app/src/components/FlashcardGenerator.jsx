...
// --- Helper: safe JSON parse ---
    ...
    const handleDoneConfirmYes = async () => {
        ...
        try {
            ...
            console.log("Printing all saved flashcards individually:");
            savedFlashcards.forEach((card, i) => {
                console.log(
                    `#${i + 1}:`,
                    "Front:", card.front,
                    "| Back:", card.back,
                    "| Multiple Choice:", card.isMultipleChoice
                );
            });
                    ...
                    <div className={styles.viewerContent}>
                        ...
                        <div className={styles.flashcardActions}>
                           ...
                           <button
                            type="button"
                            onClick={() => {
                                const [question, relevantText] = currentFlashcard;
